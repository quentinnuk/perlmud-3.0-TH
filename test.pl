...
my $instruction = 'if ( mud_ifblind($me,$arg,$arg1,$arg2,\'null\',\'1\') ) {&tellPlayer($me,$objects[0]{"msg1"}); }';
my @objects;
...
print "eval complete\n";
print "inline\n";
if ( mud_testsmall($me,$arg,$arg1,$arg2,'null') ) {&tellPlayer($me,$objects[0]{"msg1"}); } else { &tellPlayer($me,$objects[0]{"msg2"}); }print "inline complete\n";
